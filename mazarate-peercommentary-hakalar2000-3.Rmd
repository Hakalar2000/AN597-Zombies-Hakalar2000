---
title: "mazarate-PeerCommentary-Hakalar2000-3"
author: "Me"
...
Great work! your annotations made it super clear to see your intentions in every line of code. Also good job in taking some extra steps such as selecting out only the quantitative variables in the data and experimenting with the box plots in one pane and scatter plots in one plot. 

Some comments:

Line 126: you can attach instead of assign the variables for the qqplots, that's what I did!

Confidence intervals: I think the way you looked for the stats in the non-normal distributions is good, but if you take a look at the histograms you can get an idea of what kind of distribution it is. With this, you can use functions specific for this type of distribution. 

100 replications: I dont think rnorm should be used to pull the subsets themselves. I also used the replicate function and worked from that (though I was a little lost in how to find the means, but your way seems to work).

I think that he's looking for the replicated distributions to look similar if not the same as the first one from question 5. 

Are you re-replicating the subsets when you find the mean? If so, then I think that you need to use set.seed in the beginning so that the subsets are the same throughout. 
